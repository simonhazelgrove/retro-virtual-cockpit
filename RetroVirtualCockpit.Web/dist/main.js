...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cockpit_configs; });
/* harmony import */ var _configs_f16cp_st_am__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configs/f16cp_st_am */ "./src/configs/f16cp_st_am.js");
/* harmony import */ var _configs_f19sf_st_am__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./configs/f19sf_st_am */ "./src/configs/f19sf_st_am.js");



function cockpit_configs() {
    return [
        Object(_configs_f16cp_st_am__WEBPACK_IMPORTED_MODULE_0__["default"])(),
        Object(_configs_f19sf_st_am__WEBPACK_IMPORTED_MODULE_1__["default"])()
    ]
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return cockpit_ui; });
...
/* harmony import */ var _websockets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./websockets */ "./src/websockets.js");
    ...
    return {
        setupButtonControl: function (control, config) {
            control.on("click", function (event) {
                Object(_audio__WEBPACK_IMPORTED_MODULE_1__["default"])().bumpSound.play();
                if (config.press) {
                    _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.press);
                }
            });
        },
        setupHorizontalButtonControl: function (control, config) {
            control.on("click", function (event) {
                ...
                if (posX >= middleX && config.right) {
                    _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.right);
                } else if (posX < middleX && config.left) {
                    _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.left);
                }   
            });
        },
        setupSwitchControl: function (control, config) {
            ...
            control.on("click", function (event) {
                ...
                Object(_audio__WEBPACK_IMPORTED_MODULE_1__["default"])().switchSound.play();

                if (config.flip) {
                    _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.flip);
                }

                if (control.hasClass("on")) {
                    if (config.off) {
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.off);
                    }
                } else {
                    if (config.on) {
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.on);
                    }
                }
        ...
        setupKnobControl: function (control, config) {
            ...
            control.on("click", function (event) {
                ...
                if (config.turn) {
                    _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.turn);
                }
        ...
        setupThrottleControl: function (control, config) {
            ...
            if (config.min || config.max) {
                ...
                control.on("dblclick", function (event) {
                    ...
                    if (posY >= middleY && config.min) {
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.min);
                        handle.animate({ top: 40 }, 200);
                    } else if (posY < middleY && config.max) {
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.max);
                        handle.animate({ top: -40 }, 200);
                    }
                });
            }
            ...
            if (config.up || config.down) {
                handle.on("swipeup", function (event) {
                    handle.animate({ top: -40 }, 200)
                        .animate({ top: 0 }, 200);
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.up);
                });
                handle.on("swipedown", function (event) {
                    handle.animate({ top: 40 }, 200)
                        .animate({ top: 0 }, 200);
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.down);
                });
                ...
                handle.on("mousedown", function (event) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("mouseup", function (event) {
                        // End drag
            ...
            if (config.pull) {
                ...
                control.on("swipedown", function (event) {
                    control.animate({ top: 20 }, 200)
                        .animate({ top: 0 }, 200);
                        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].sendMessage(config.pull);
                });
        ...
        configureControl: function (config) {
            var control = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#" + config.id);
        ...
        addControl: function (config, container) {
            var slot = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", { class: "control-slot" });
            if (config.decoration) {
                slot.addClass(config.decoration);
            }
            var control = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", { class: "control " + config.type });
            slot.append(control);
            switch (config.type) {
                case "button":
                case "button-red":
                ...
                case "knob":
                    if (config.label) {
                        slot.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>" + config.label + "</p>"));
                    }
                    break;
                case "throttle":
                    control.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", { class: "throttle-base" }));
                    control.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", { class: "throttle-handle" }));
                    break;
                case "handle":
                    ...
                    if (config.label) {
                        control.append(jquery__WEBPACK_IMPORTED_MODULE_0___default()("<p>" + config.label + "</p>"));
                    }
                    break;
            }
            return slot;
        ...
        setupPanelRow: function (config, container) {
            var panelRow = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<div>", { class: "control-panel-row" });
            var me = this;
        ...
        setupCockpit: function (config) {
            var container = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#virtual-cockpit");
            container.empty();
            var me = this;
        ...
        setupConfigMenu: function (configs) {
            ...
            configs.forEach(function(config) {
                var link = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<li class='menu-item'><a href='#'>" + config.title + "</a></li>");
                link.click(function () {
...
/* harmony import */ var _cockpit_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cockpit-ui */ "./src/cockpit-ui.js");
/* harmony import */ var _cockpit_configs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cockpit-configs */ "./src/cockpit-configs.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connect-form").submit(function (event) {
        event.preventDefault();
        Object(_cookie__WEBPACK_IMPORTED_MODULE_1__["default"])().setCookie("connect-key", jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connect-key").val(), 365 * 10);
        _websockets__WEBPACK_IMPORTED_MODULE_2__["default"].connect();
    });

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connected-icon").click(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connect-panel").slideToggle(1000);
    });

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connect-key").val(Object(_cookie__WEBPACK_IMPORTED_MODULE_1__["default"])().getCookie("connect-key"));

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#menu-icon").hover(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass("text-info");
    }, function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass("text-info");
    });

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#debug").click(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#messageCode").toggleClass("not-hidden");
    });

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#nightmode").change(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").toggleClass("night");
    });

    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#fullscreen").click(function () {
        Object(_device__WEBPACK_IMPORTED_MODULE_3__["default"])().requestFullScreen();
    });

    Object(_cockpit_ui__WEBPACK_IMPORTED_MODULE_4__["default"])().setupConfigMenu(Object(_cockpit_configs__WEBPACK_IMPORTED_MODULE_5__["default"])());
});
...
function log() {
    return {
        logFade: null,
        logElement: jquery__WEBPACK_IMPORTED_MODULE_0___default()("#messageCode"),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    connect: function () {
        ...
        this.connection.onopen = function () {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connect-panel").slideToggle(1000);
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connected-icon").toggleClass("text-muted");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#connected-icon").toggleClass("text-warning");
            jquery__WEBPACK_IMPORTED_MODULE_0___default()("#error-text").text("");
        };

        // Log errors
        this.connection.onerror = function (error) {
            Object(_log__WEBPACK_IMPORTED_MODULE_1__["default"])().logError("Connection error - is the client running?");
        };

        // Log messages from the server
        this.connection.onmessage = function (e) {
            Object(_log__WEBPACK_IMPORTED_MODULE_1__["default"])().logError("Server: " + e.data);
        };
    },
    sendMessage: function (value) {
        Object(_log__WEBPACK_IMPORTED_MODULE_1__["default"])().logMessage(value);
